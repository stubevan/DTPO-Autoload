...
def check_method(pattern_spec) :
    ...
    entry = (
        ...
        ('value', 'description', 'Description 1'),
        ('pattern', 'string1_pattern', ('Pattern 1 key', '!!Pattern 1 value', 0)),
        ('pattern', 'string2_pattern', ()),
        ('pattern', 'date_pattern', ( 'Statement Date', 'Statement Date ([1-9]+.*2[0-9][0-9][0-9])', 1))
    )
